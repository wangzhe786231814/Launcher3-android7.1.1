...
public class LauncherStateTransitionAnimation {
    ...
    public void startAnimationToWorkspace(final Launcher.State fromState,
        ...
        Log.d(TAG, "startAnimationToWorkspace: fromState=="+fromState);
    ...
    private AnimatorSet startAnimationToWorkspaceFromOverlay(final Workspace.State fromWorkspaceState,
        ...
        startWorkspaceSearchBarAnimation(animation, fromWorkspaceState, toWorkspaceState,
                animated ? revealDuration : 0, overlaySearchBarView);
        Log.d(TAG, "startAnimationToWorkspaceFromOverlay: animated="+animated+"    initialized=="+initialized);
        Log.d(TAG, "startAnimationToWorkspaceFromOverlay: workspaceAnim=="+workspaceAnim);
        if (animated && initialized) {
            // Play the workspace animation
            if (workspaceAnim != null) {
                animation.play(workspaceAnim);
            ...
            Log.d(TAG, "startAnimationToWorkspaceFromOverlay: fromView.getVisibility()=="+fromView.getVisibility());
