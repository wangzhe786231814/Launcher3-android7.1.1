...
class AlphaUpdateListener extends AnimatorListenerAdapter implements ValueAnimator.AnimatorUpdateListener {
    ...
    public static void updateVisibility(View view, boolean accessibilityEnabled) {
        ...
        Log.d("updateVisibility", "updateVisibility: View=="+View.generateViewId());
        Log.d("updateVisibility", "updateVisibility: view.getAlpha()=="+view.getAlpha());
        Log.d("updateVisibility", "updateVisibility: invisibleState=="+invisibleState);
        Log.d("updateVisibility", "updateVisibility: invisibleState=="+view.toString());
        Log.d("updateVisibility", "updateVisibility: view.getVisibility()=="+view.getVisibility());
        if (view.getAlpha() < ALPHA_CUTOFF_THRESHOLD && view.getVisibility() != invisibleState) {
            view.setVisibility(invisibleState);
        } else if (view.getAlpha() > ALPHA_CUTOFF_THRESHOLD
                && view.getVisibility() != View.VISIBLE) {
            Log.d("updateVisibility", "updateVisibility: over");
...
//        Log.d("updateVisibility", "onAnimationStart: "+mView.getId());
//        Log.d("updateVisibility", "onAnimationStart: "+mView.toString());
...
public class WorkspaceStateTransitionAnimation {
    ...
    private void animateWorkspace(final TransitionStates states, int toPage, final boolean animated,
        ...
        Log.d(TAG, "animateWorkspace: animated=="+animated);
        if (animated) {
